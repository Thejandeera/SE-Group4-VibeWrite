      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between h-16 sm:h-18 lg:h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button className="text-gray-300 hover:text-white transition-all duration-300 font-medium relative group">
              Sign In
            ...
            <button className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white px-6 py-2.5 rounded-xl font-semibold shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 transition-all duration-300 hover:scale-105 transform">
              Get Started
            </button>
          </div>
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-800/50 bg-black/60 backdrop-blur-sm">
            ...
            <div className="px-3 py-2 space-y-3 border-t border-gray-800/50 mt-3 pt-4">
              <button className="block w-full text-left px-4 py-3 text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-all duration-300 font-medium">
                Sign In
              </button>
              <button className="block w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white px-4 py-3 rounded-xl font-semibold shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 transition-all duration-300 text-center transform hover:scale-[1.02]">
                Get Started
              </button>
            </div>
          </div>
