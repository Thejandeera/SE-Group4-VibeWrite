  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8  pt-35 py-12 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-12 sm:mb-16">
        <button className="group bg-white text-black px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-200 flex items-center space-x-2 w-full sm:w-auto justify-center">
          <span>Sign Up Free</span>
          <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-200" />
        </button>
        <button className="bg-transparent border border-gray-600 text-white px-8 py-3 rounded-lg font-semibold hover:border-gray-400 hover:bg-gray-800/50 transition-all duration-200 w-full sm:w-auto">
          Try Now
        </button>
      </div>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto">
        <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50 overflow-hidden shadow-2xl">
          ...
          <div className="p-6 space-y-4">
            ...
            {/* Text Content with Loading Bars */}
