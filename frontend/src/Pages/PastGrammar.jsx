      ...
      <div className="min-h-screen bg-white text-gray-800 p-4 md:p-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center py-10 md:py-20">
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 md:p-8">
              <h2 className="text-xl md:text-2xl font-bold text-red-600 mb-3 md:mb-4">Error</h2>
              <p className="text-gray-600 mb-4 md:mb-6">{error}</p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <button
                  onClick={fetchGrammarHistory}
                  className="px-4 py-2 md:px-6 md:py-2 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors text-sm md:text-base text-white"
                >
                  Retry
                </button>
                <button
                  onClick={navigateBack}
                  className="px-4 py-2 md:px-6 md:py-2 bg-gray-600 hover:bg-gray-700 rounded-lg transition-colors text-sm md:text-base text-white"
                >
                  Go Back
                </button>
              </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-600 text-sm md:text-base">Review your previous grammar analysis results</p>
          </div>
          <button
            onClick={navigateBack}
            className="px-4 py-2 md:px-6 md:py-2 bg-gradient-to-r from-gray-500 to-gray-600 rounded-lg hover:from-gray-600 hover:to-gray-700 transform hover:scale-105 transition-all duration-300 font-medium text-sm md:text-base w-full sm:w-auto text-white"
          >
            ← Back to Editor
          </button>
        </div>
        ...
        {grammarHistory.length === 0 ? (
          <div className="text-center py-10 md:py-20">
            <div className="bg-gray-50 rounded-xl p-6 md:p-12 border border-gray-200">
              <div className="text-4xl md:text-6xl mb-4 md:mb-6">📝</div>
              <h2 className="text-xl md:text-2xl font-bold text-gray-700 mb-3 md:mb-4">No Grammar Checks Yet</h2>
              <p className="text-gray-500 mb-6 md:mb-8 text-sm md:text-base">Start checking your grammar to see your history here.</p>
              <button
                onClick={navigateBack}
                className="px-6 py-2 md:px-8 md:py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg hover:from-blue-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 font-medium text-sm md:text-base text-white"
              >
                Start Grammar Check
              </button>
            </div>
          ...
          <div className="space-y-4 md:space-y-6 animate-fadeIn">
            ...
            <div className="grid grid-cols-2 gap-2 md:gap-4 md:grid-cols-4 mb-6 md:mb-8">
              ...
              <div className="bg-gradient-to-br from-orange-500 to-orange-600 p-4 md:p-6 rounded-xl shadow-lg text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {grammarHistory.map((check, index) => (
                <div
                  key={check.id}
                  className="bg-gray-50 rounded-xl p-4 md:p-6 border border-gray-200 hover-scale cursor-pointer animate-slideIn"
                  style={{ animationDelay: `${index * 0.1}s` }}
                  onClick={() => setSelectedCheck(selectedCheck?.id === check.id ? null : check)}
                >
                  <div className="flex justify-between items-start mb-3 md:mb-4">
                    <div>
                      <h3 className="text-lg md:text-xl font-semibold text-blue-600 mb-1 md:mb-2">
                  ...
                  <div className="bg-white p-2 md:p-3 rounded-lg mb-3 md:mb-4 border border-gray-200">
                  ...
                  <div className="grid grid-cols-4 gap-1 md:gap-2 text-center text-xs">
                    <div className="bg-white p-1 md:p-2 rounded border border-gray-200">
                      <div className="font-semibold text-blue-600">{check.metrics.wordCount}</div>
                      <div className="text-gray-500 text-2xs md:text-xs">Words</div>
                    </div>
                    <div className="bg-white p-1 md:p-2 rounded border border-gray-200">
                      <div className="font-semibold text-green-600">{check.metrics.sentenceCount}</div>
                      <div className="text-gray-500 text-2xs md:text-xs">Sentences</div>
                    </div>
                    <div className="bg-white p-1 md:p-2 rounded border border-gray-200">
                      <div className="font-semibold text-orange-600">{check.metrics.grammarErrors}</div>
                      <div className="text-gray-500 text-2xs md:text-xs">Grammar</div>
                    </div>
                    <div className="bg-white p-1 md:p-2 rounded border border-gray-200">
                      <div className="font-semibold text-purple-600">{check.metrics.readabilityScore.toFixed(0)}</div>
        ...
        {selectedCheck && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-2 md:p-4 z-50">
            <div className="bg-white rounded-xl p-4 md:p-6 max-w-6xl w-full max-h-[90vh] overflow-y-auto border border-gray-300 shadow-2xl">
              ...
              <div className="grid grid-cols-2 gap-2 md:gap-4 md:grid-cols-4 mb-6 md:mb-8">
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-2 md:p-4 rounded-xl text-white">
                ...
                <div className="bg-gradient-to-br from-red-500 to-red-600 p-2 md:p-4 rounded-xl text-white">
                ...
                <div className="bg-gradient-to-br from-green-500 to-green-600 p-2 md:p-4 rounded-xl text-white">
                ...
                <div className="bg-gradient-to-br from-purple-500 to-purple-600 p-2 md:p-4 rounded-xl text-white">
              ...
              <div className="grid grid-cols-1 gap-4 md:gap-6 lg:grid-cols-2 mb-6 md:mb-8">
                <div className="bg-gray-50 p-4 md:p-6 rounded-xl border border-gray-200">
                  ...
                  <div className="bg-white p-3 md:p-4 rounded-lg border border-gray-300">
                    <p className="text-gray-700 whitespace-pre-wrap text-sm md:text-base">{selectedCheck.originalText}</p>
                  </div>
                </div>
                <div className="bg-gray-50 p-4 md:p-6 rounded-xl border border-gray-200">
                  <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-green-600">Corrected Text</h3>
                  <div className="bg-white p-3 md:p-4 rounded-lg border border-gray-300">
                    <p className="text-gray-700 whitespace-pre-wrap text-sm md:text-base">{selectedCheck.correctedText}</p>
                  </div>
                </div>
              </div>
              ...
              {selectedCheck.errors.length > 0 && (
                <div className="bg-gray-50 rounded-xl p-4 md:p-6 border border-gray-200 mb-6 md:mb-8">
                      ...
                      <tbody>
                        {selectedCheck.errors.map((error, index) => (
                          <tr key={index} className="border-b border-gray-200 hover:bg-gray-100 transition-colors">
                            ...
                            <td className="p-2 md:p-3 font-mono bg-red-100 rounded px-1 py-0.5 md:px-2 md:py-1 text-2xs md:text-xs">
                              "{error.originalText}"
                            </td>
                            <td className="p-2 md:p-3 font-mono bg-green-100 rounded px-1 py-0.5 md:px-2 md:py-1 text-2xs md:text-xs">
                              "{error.suggestedText}"
                            </td>
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6 border border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-2 md:gap-4 md:grid-cols-4">
                  <div className="bg-white p-2 md:p-4 rounded-lg text-center border border-gray-200">
                    <p className="text-lg md:text-2xl font-bold text-blue-600">{selectedCheck.metrics.sentenceCount}</p>
                    <p className="text-gray-500 text-xs md:text-sm">Sentences</p>
                  </div>
                  <div className="bg-white p-2 md:p-4 rounded-lg text-center border border-gray-200">
                    <p className="text-lg md:text-2xl font-bold text-red-600">{selectedCheck.metrics.spellingErrors}</p>
                    <p className="text-gray-500 text-xs md:text-sm">Spelling Errors</p>
                  </div>
                  <div className="bg-white p-2 md:p-4 rounded-lg text-center border border-gray-200">
                    <p className="text-lg md:text-2xl font-bold text-orange-600">{selectedCheck.metrics.grammarErrors}</p>
                    <p className="text-gray-500 text-xs md:text-sm">Grammar Errors</p>
                  </div>
                  <div className="bg-white p-2 md:p-4 rounded-lg text-center border border-gray-200">
                    <p className="text-lg md:text-2xl font-bold text-purple-600">{selectedCheck.metrics.punctuationErrors}</p>
                    <p className="text-gray-500 text-xs md:text-sm">Punctuation Errors</p>
                  </div>
                </div>
              </div>
            </div>
